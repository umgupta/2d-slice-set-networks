config = {
    ...
    "data.name"                         : "ukbb_brain_age",
    "data.root_path"                    : "<root path of the data folder>",
    "data.train_csv"                    : "data/ukbb/train.csv",
    "data.test_csv"                     : "data/ukbb/test.csv",
    "data.valid_csv"                    : "data/ukbb/valid.csv",
    ...
    "model.arch.file"                   : "src/arch/brain_age/brain_age_3d.py",
